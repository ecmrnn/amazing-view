        ...
        <section class="py-5 space-y-5 max-w-screen-xl mx-auto" id="form">
            ...
            <article x-data="{ 
                ...
                <div class="col-span-2">
                    ...
                    <div class="rounded-lg overflow-hidden border grid grid-cols-2">
                        <div class="p-5 py-2 col-span-2 border-b bg-slate-100">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2 mt-3">
                            <div class="px-3 py-2 border rounded-lg">
                                ...
                                <p x-text="date_in === '' ? 'Select a Date' : formatDate(date_in)" class="font-semibold"></p>
                                <p class="text-zinc-800/50 text-xs">From: 2:00 PM</p>
                            </div>
                            <div class="px-3 py-2 border rounded-lg">
                                <p class="text-zinc-800/50 text-xs">Check-out</p>
                                <p x-text="date_out === '' ? 'Select a Date' : formatDate(date_out)" class="font-semibold"></p>
