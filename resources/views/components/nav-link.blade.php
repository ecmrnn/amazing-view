...
<a {{ $attributes->merge(['class' => $classes]) }} wire:navigate.hover>
    ...
    <div 
        ...
        class="absolute h-1 transition-all duration-200 ease-in-out -translate-y-1/2 bg-blue-500 rounded-full -right-5 top-1/2 md:translate-y-0 md:top-full md:bottom-0 md:-translate-x-1/2 md:left-1/2 group-hover:w-1/2">
    </div>
</a>