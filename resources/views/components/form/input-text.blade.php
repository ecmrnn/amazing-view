...
<div class="relative z-0 w-full">
    <input 
        {{ $attributes->merge(['class' => 'block px-2.5 pt-3 w-full text-sm bg-white rounded-md border border-slate-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer z-0 transition-colors ease-in-out duration-200 invalid:border-red-500 invalid:bg-red-50 focus:invalid:border-red-500 disabled:bg-slate-100 disabled:opacity-50']) }}
