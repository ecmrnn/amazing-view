...
<x-form.form-section class="relative h-min">
    {{-- Select Room --}}
    <x-form.form-header step="3" title="Room &amp; Additional Details" />
    ...
    <div x-show="can_select_room && !can_submit_payment" x-collapse.duration.1000ms>
        <x-form.form-body>
            <div class="p-5 space-y-3">
                ...
                {{-- View Selected Rooms --}}
                <p class="max-w-xs text-xs">If you wish to <strong class="font-semibold text-red-500">remove</strong> or view all the selected rooms, click the button below.</p>
