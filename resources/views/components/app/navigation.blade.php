    ...
    <div>
        <x-tooltip text="Dashboard" dir="right">
            <x-app-nav-link x-ref="content" :active="Request::is('dashboard')" href="{{ route('dashboard') }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                ...
                <span x-show="expanded" x-cloak class="text-xs font-semibold">Dashboard</span>
            </x-app-nav-link>
        </x-tooltip>
        ...
        @can('read own reservations')
            <x-tooltip text="Reservations" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/reservation*')" href="{{ route('app.reservations.guest-reservations', ['user' => Auth::user()->id]) }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    ...
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Reservations</span>
                </x-app-nav-link>
            </x-tooltip>
        @endcan
        ...
        @can('read own billings')
            <x-tooltip text="Billings" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/billing*')" href="{{ route('app.billings.guest-billings', ['user' => Auth::user()->id]) }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet-icon lucide-wallet"><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/></svg>
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Billings</span>
                </x-app-nav-link>
            </x-tooltip>
        @endcan
        ...
        @can('read guests')
            <x-tooltip text="Guests" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/guests*')" href="{{ route('app.guests.index') }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    ...
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Guests</span>
                </x-app-nav-link>
            </x-tooltip>
        @endcan
        ...
        @can('read rooms')
            <x-tooltip text="Rooms" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/rooms*')" href="{{ route('app.rooms.index') }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    ...
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Rooms</span>
                </x-app-nav-link>
            </x-tooltip>
        @endcan
        ...
        <div class="pt-2 border-t border-slate-200">
            <x-tooltip text="Users" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/users*')" href="{{ route('app.users.index') }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    ...
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Users</span>
                </x-app-nav-link>
            </x-tooltip>
            ...
            <x-tooltip text="Reports" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/reports*')" href="{{ route('app.reports.index') }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    ...
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Reports</span>
                </x-app-nav-link>
            </x-tooltip>
            ...
            <x-tooltip text="Content" dir="right">
                <x-app-nav-link x-ref="content" :active="Request::is('app/content*')" href="{{ route('app.contents.index') }}" x-bind:class="expanded ? '' : '*:mx-auto'" class="flex items-center gap-3 p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-panels-top-left"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
                    <span x-show="expanded" x-cloak class="text-xs font-semibold">Content</span>
                </x-app-nav-link>
            </x-tooltip>
        </div>
    @endrole
@elseif ($screen == 'mobile')
    <div class="grid w-full">
        ...
        @can('read own billings')
            <x-app-nav-link x-ref="content" :active="Request::is('app/billing*')" href="{{ route('app.billings.guest-billings', ['user' => Auth::user()->id]) }}" class="flex items-center gap-3 p-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet-icon lucide-wallet"><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/></svg>
