<template x-teleport="body">
    <ul 
        ...
        "
        class="fixed block w-full group z-[99999] max-w-xs"
        :class="{
            'right-0 top-0 sm:mt-6 sm:mr-6': position=='top-right',
            'left-0 top-0 sm:mt-6 sm:ml-6': position=='top-left',
            'left-1/2 -translate-x-1/2 top-0 sm:mt-5': position=='top-center',
                    ...
                    <template x-if="!toast.html">
                        <div class="relative">
                            <div class="flex items-center"
                                ...
                                <p class="text-sm font-semibold leading-none text-zinc-800" x-text="toast.message"></p>
                            </div>
                            <p x-show="toast.description" 
                                :class="{ 'pl-5' : toast.type!='default' }"
                                class="mt-1.5 text-xs leading-none" x-text="toast.description"></p>
                        </div>
                    </template>
                    <template x-if="toast.html">
