...
<div 
    ...
    <div x-ref="tooltip" x-show="tooltipVisible" :class="{ 'top-0 left-1/2 -translate-x-1/2 -mt-0.5 -translate-y-full'
        : tooltipPosition == 'top', 'top-1/2 -translate-y-1/2 -ml-0.5 left-0 -translate-x-full'
        ...
        <div x-show="tooltipVisible" x-transition class="relative px-2 py-1 text-white rounded bg-zinc-800 backdrop-blur-md bg-opacity-90">
            <p x-text="tooltipText" class="block text-xs max-w-[250px] {{ !$textWrap ?: 'whitespace-nowrap'}}"></p>
