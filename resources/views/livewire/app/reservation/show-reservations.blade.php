<div class="flex flex-col gap-5 md:flex-row">
    <aside class="space-y-5 shrink-0 min-w-52">
        ...
        <ul>
            ...
            <li>
                <x-side-nav-link :status="\App\Enums\ReservationStatus::CHECKED_IN->value" href="{{ route('app.reservations.index', ['status' => \App\Enums\ReservationStatus::CHECKED_IN->value]) }}">
                    <div class="flex items-center gap-1">
            ...
            <li>
                <x-side-nav-link :status="\App\Enums\ReservationStatus::RESCHEDULED->value" href="{{ route('app.reservations.index', ['status' => \App\Enums\ReservationStatus::RESCHEDULED->value]) }}">
                    <div class="flex items-center gap-1">
            ...
            <li>
                <x-side-nav-link :status="\App\Enums\ReservationStatus::NO_SHOW->value" href="{{ route('app.reservations.index', ['status' => \App\Enums\ReservationStatus::NO_SHOW->value]) }}">
                    <div class="flex items-center gap-1">
                        <span>No-Show</span>
