<div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:gap-5 lg:grid-cols-4">
    <x-app.report
            ...
            {{-- x-on:click="$dispatch('generate-report', { type: 'reservation summary' })" --}}
        >
        <x-slot:icon>
    ...
    <x-app.report
            ...
            {{-- x-on:click="$dispatch('generate-report', { type: 'daily reservations' })" --}}
        >
        <x-slot:icon>
    ...
    <x-app.report
            ...
            {{-- x-on:click="$dispatch('generate-report', { type: 'occupancy report' })" --}}
        >
        <x-slot:icon>
    ...
    <x-app.report
            ...
            {{-- x-on:click="$dispatch('generate-report', { type: 'financial report' })" --}}
        >
        <x-slot:icon>
