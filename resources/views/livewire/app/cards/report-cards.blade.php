<div class="grid grid-cols-2 gap-3 lg:gap-5 lg:grid-cols-4">
    <x-app.report
            ...
            x-on:click="$dispatch('generate-report', { type: 'reservation_summary' })"
        >
        <x-slot:icon>
    ...
    <x-app.report
            ...
            x-on:click="$dispatch('generate-report', { type: 'daily_reservations' })"
        >
        <x-slot:icon>
    ...
    <x-app.report
            ...
            x-on:click="$dispatch('generate-report', { type: 'occupancy' })"
        >
        <x-slot:icon>
    ...
    <x-app.report
            ...
            x-on:click="$dispatch('generate-report', { type: 'financial' })"
        >
        <x-slot:icon>
