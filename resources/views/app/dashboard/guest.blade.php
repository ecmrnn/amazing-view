<x-app-layout>
    ...
    <div class="max-w-screen-lg mx-auto space-y-5">
        ...
        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
           ...
           <x-quick-action href="{{ route('app.reservations.guest-reservations', ['user' => Auth::user()->id]) }}">
                <div class="flex items-center gap-5">
           ...
           <x-quick-action href="{{ route('app.billings.guest-billings', ['user' => Auth::user()->id]) }}">
                <div class="flex items-center gap-5">
