    ...
    public function render()
    {
        ...
        <section x-on:report-generated.window="show = false" class="p-5 space-y-5 bg-white">
            <div class="flex items-center gap-3">
                ...
                <hgroup>
                    <h2 class="font-semibold capitalize">Reservation Summary</h2>
                    <p class="text-xs">Creating a reservation summary report.</p>
                </hgroup>
            </div>
            ...
            <div class="space-y-3">
                <div class="space-y-2">
                    <div>
                        <x-form.input-label for="name">Name &amp; Description</x-form.input-label>
                    ...
                    {{-- Description --}}
                    <div class="space-y-2">
                        <x-form.input-text id="description" label="Description" wire:model.live='description' />
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="w-full space-y-2">
                        <x-form.input-label for="start_date">From</x-form.input-label>
                        <x-form.input-date id="start_date" wire:model.live='start_date' class="w-full" />
                        <x-form.input-error field="start_date" />
                    </div>
                    <div class="w-full space-y-2">
                        <x-form.input-label for="end_date">To</x-form.input-label>
                        <x-form.input-date id="end_date" wire:model.live='end_date' min="{{ $start_date }}" class="w-full" />
                ...
                {{-- Note --}}
                <div class="space-y-2">
                    <x-form.input-label for="note">Additional Note &lpar;Optional&rpar;</x-form.input-label>
                    <x-form.input-text id="note" name="note" label="Note" wire:model.live='note' />
                    <x-form.input-error field="note" />
                </div>

                {{-- Format --}}
                <div class="space-y-2">
                    <x-form.input-label for="format">Select Format</x-form.input-label>
                    <x-form.select id="format" wire:model.live='format' name="format">
