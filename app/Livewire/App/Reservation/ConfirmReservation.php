...
class ConfirmReservation extends Component
{
    ...
    public function validateReservation() {
        ...
        $this->dispatch('open-modal', 'confirm-reservation');
        $this->dispatch('reservation-validated');
    }
    ...
    public function render()
    {
        ...
        <div>
            <x-modal.full name="show-downpayment-modal" maxWidth="sm">
                <div x-data="{ checked: false, amount: @entangle('amount') }" x-on:reservation-validated.window="show = false">
            ...
            <x-modal.full name='confirm-reservation' maxWidth='sm'>
                <div class="p-5 space-y-5" x-on:reservation-confirmed.window="show = false">
                    ...
                    <div class="flex justify-end gap-1">
                        <x-secondary-button type="button" x-on:click="show = false; $dispatch('open-modal', 'show-downpayment-modal')">Back</x-secondary-button>
